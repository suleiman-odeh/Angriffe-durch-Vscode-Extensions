...
## Angriffe testen
 node.js muss zuerst unter https://nodejs.org/en/download installiert werden.
Dann die Angriffe entweder als Vsix Dateien installieren oder die Angriffe dierkt testen.

## installtion als Vsix:
In der `Vsix files` Ordner befindet sich für jede Erweiterung eine Vsix Datei. 
